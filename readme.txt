=== wp-amaps ===
Contributors: rccoder
Tags: map, amaps,地图插件
Donate link: http://www.rccoder.net
...
== Description ==
基于高德地图的WordPress插件，利用短代码可以在任何你想插入地图的地方插入有标记的地图。支持自定义尺寸大小,自定义其他描述
...
如果有的话，请移步至[wp-amaps主页](https://github.com/rccoder/wp-amaps)获取帮助
== Screenshots ==
1. 正常状态下就是这样
== Changelog ==
= 1.0 =
* Initial release.
= 1.1 =
* Change the Name (From wp-amaps-plugin to wp-amaps)
= 1.2 =
* 更新介绍
= 1.3 =
* 学习SVN
